...
% Template Designed by Dr. Alamgir Sardar, Professor, Department of Computer Science & Engineering, Sister Nivedita University, New Town, Kolkata, India
...
% \usepackage[none]{hyphenat}    % Disable hyphenation - COMMENTED OUT TO FIX OVERFLOW
...
\emergencystretch=1em          % Allow extra stretch in lines to prevent overflow
...
\graphicspath{{./figure/}}     % set path for images
...
\usetikzlibrary{shapes.geometric} % diamond, ellipse, trapezium shapes
\usepackage{pgfplots}          % plotting graphs and charts
